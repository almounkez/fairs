...
<<<<<<< HEAD
                        <img src="{{ asset('storage/products/' . $product->imgfile) }}" class="img-fluid img-thumbnail">
=======
...
=======
                    ...
                    <div class="row">
                        <div class="col-md-4 col-form-label " style="text-align:start">
                            <label for="description">{{ __('Subcategory') }}:</label>
                        </div>
                        <div class="col-8">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-form-label text-md-left">
                            <label for="descp_ar">{{ __('Arabic Description') }}:</label>
                        </div>
                        <div class="col-8"><input class="form-control" type="text" name="descp_ar"
                                value="@if (!empty($product) && old('descp_ar', $product->descp_ar)) {{ $product->descp_ar }}@else{{old('descp_ar')}} @endif">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 col-form-label text-md-left">
                            <label for="descp_en">{{ __('English Description') }}:</label>
                        </div>
                        <div class="col-8"><input class="form-control" type="text" name="descp_en"
                                value="@if (!empty($product) && old('descp_en', $product->descp_en)) {{ $product->descp_en }}@else{{old('descp_en')}} @endif">
>>>>>>> 6004327a64e84c70e131b1014e6b9a8fcf77034e
                        </div>
                    </div>
